...
async function scrape() {
  const html = await fetchHtml('https://growthguys.is/shop/categories/peptides/?product-page=2');
  ...
  console.log('Found product URLs:', urls);
  ...
  fs.writeFileSync('scraped_page2.json', JSON.stringify(results, null, 2));
}
