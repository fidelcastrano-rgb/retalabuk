         ...
         <div className="grid md:grid-cols-2 gap-8 lg:gap-16">
           ...
           <div className="space-y-6">
             <div className="bg-white border-2 border-[#10B981] p-8 rounded shadow-md relative">
               ...
               <a href="https://wa.me/447727171512" className="inline-block w-full text-center py-3 bg-[#25D366] text-white font-bold rounded hover:bg-opacity-90">
                 Message +447727171512
               </a>
