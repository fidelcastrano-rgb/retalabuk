...
export const faqs: FAQ[] = [
  ...
  { question: "What payment methods do you accept?", answer: "We accept Crypto (Bitcoin, USDT, Ethereum) with an automatic 10% discount on every order, Bank Transfer, and Skrill. Crypto is the best and preferred payment option for those who want to be anonymous.", category: "Buying & Ordering" },
