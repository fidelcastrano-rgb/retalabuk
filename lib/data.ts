...
export const faqs: FAQ[] = [
  ...
  { question: "What payment methods do you accept?", answer: "We accept Credit & Debit Cards (Visa, MasterCard, AMEX via instant secure Bachs gateway), Crypto (Bitcoin, USDT, Ethereum), Bank Transfer, Revolut, and Skrill. Crypto is the best and preferred payment option for those who want to be anonymous.", category: "Buying & Ordering" },
